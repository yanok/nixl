...
class nixl_agent:
    def __init__(
        ...
        thread_config = nixl_conf.sync_mode if nixl_conf.sync_mode is not None else (
            nixl_thread_sync_t.NIXL_THREAD_SYNC_STRICT if nixl_conf.enable_listen
        ...
        agent_config.syncMode = thread_config.value
